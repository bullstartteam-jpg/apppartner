...
export default function Reasons() {
  ...
  // Partners can create their own reasons (backend allows admin + partner on
  // POST /reasons); rename/delete stay admin-only.
  const canCreate = isAdmin || hasRole('partner');
